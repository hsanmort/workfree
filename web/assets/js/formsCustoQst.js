...
var $addPropLink = $('<hr><a href="#" class="add_prop_link btn-u">Add a proposition</a>');
var $newLinkLi = $('<li></li>').append($addPropLink);

jQuery(document).ready(function() {

    // Get the ul that holds the collection of props
   var $collectionHolder = $('ul.props');
...
function addpropForm($collectionHolder, $newLinkLi) {
    ...
    var $newFormLi = $('<li><div class="props_radio_div btn-u"><input type="radio" class="props_radio" name="reponse_props" value="1">Correct</input></div></li>').append(newForm);
...
function addRemoveBtnEdit($props) {
    ...
    for (var i = 0; i < $propsList.length; i++) {
        ...
        $($cadre).prepend("<a href='#' class='remove-prop btn-u'>x</a><div class='props_radio_div btn-u'><input type='radio' class='props_radio' name='reponse_props' value='1'>Correct</input></div><br>");
